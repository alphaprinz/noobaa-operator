...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomEnvVar) DeepCopyInto(out *CustomEnvVar) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomEnvVar.
func (in *CustomEnvVar) DeepCopy() *CustomEnvVar {
	if in == nil {
		return nil
	}
	out := new(CustomEnvVar)
	in.DeepCopyInto(out)
	return out
}
